...
/**
 * EmployeeSummaryRow — JavaFX TableView view-model for employee summaries.
 * Used for display in admin/employer finance dashboard.
 */
public class EmployeeSummaryRow {
    ...
    public double getLastNetPay() { return lastNetPay; }
    public void setLastNetPay(double lastNetPay) { this.lastNetPay = lastNetPay; }
