...
/**
 * PayslipRow — JavaFX TableView view-model for payslips.
...
public class PayslipRow {
    ...
    public String getPeriod() { return month + "/" + year; }

    public double getBaseSalary() { return baseSalary; }
    public void setBaseSalary(double baseSalary) { this.baseSalary = baseSalary; calculateTotals(); }

    public double getOvertime() { return overtime; }
    public void setOvertime(double overtime) { this.overtime = overtime; }

    public double getOvertimeTotal() { return overtimeTotal; }
    public void setOvertimeTotal(double overtimeTotal) { this.overtimeTotal = overtimeTotal; calculateTotals(); }

    public double getBonuses() { return bonuses; }
    public void setBonuses(double bonuses) { this.bonuses = bonuses; calculateTotals(); }

    public double getGross() { return gross; }

    public double getCnss() { return cnss; }

    public double getIrpp() { return irpp; }

    public double getOtherDeductions() { return otherDeductions; }
    public void setOtherDeductions(double otherDeductions) { this.otherDeductions = otherDeductions; calculateTotals(); }
