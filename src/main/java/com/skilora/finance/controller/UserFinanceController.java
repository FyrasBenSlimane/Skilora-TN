...
public class UserFinanceController implements Initializable {
    ...
    // ==================== CONTRACTS TABLE ====================
    @FXML private TableView<ContractRow> contractTable;
    @FXML private TableColumn<ContractRow, String> contract_userCol;
    @FXML private TableColumn<ContractRow, String> contract_companyCol;
    @FXML private TableColumn<ContractRow, String> contract_typeCol;
    @FXML private TableColumn<ContractRow, String> contract_positionCol;
    @FXML private TableColumn<ContractRow, Double> contract_salaryCol;
    @FXML private TableColumn<ContractRow, String> contract_startCol;
    @FXML private TableColumn<ContractRow, String> contract_endCol;
    @FXML private TableColumn<ContractRow, String> contract_statusCol;
    @FXML private Label contract_countLabel;

    // ==================== BANK ACCOUNTS TABLE ====================
    @FXML private TableView<BankAccountRow> bankAccountTable;
    @FXML private TableColumn<BankAccountRow, String> bank_userCol;
    @FXML private TableColumn<BankAccountRow, String> bank_nameCol;
    @FXML private TableColumn<BankAccountRow, String> bank_ibanCol;
    @FXML private TableColumn<BankAccountRow, String> bank_swiftCol;
    @FXML private TableColumn<BankAccountRow, String> bank_currencyCol;
    @FXML private TableColumn<BankAccountRow, Boolean> bank_primaryCol;
    @FXML private TableColumn<BankAccountRow, Boolean> bank_verifiedCol;
    @FXML private Label bank_countLabel;

    // ==================== BONUSES TABLE ====================
    @FXML private TableView<BonusRow> bonusTable;
    @FXML private TableColumn<BonusRow, String> bonus_userCol;
    @FXML private TableColumn<BonusRow, Double> bonus_amountCol;
    @FXML private TableColumn<BonusRow, String> bonus_reasonCol;
    @FXML private TableColumn<BonusRow, String> bonus_dateCol;
    @FXML private Label bonus_countLabel;

    // ==================== PAYSLIPS TABLE ====================
    @FXML private TableView<PayslipRow> payslipTable;
    @FXML private TableColumn<PayslipRow, String> payslip_userCol;
    @FXML private TableColumn<PayslipRow, String> payslip_periodCol;
    @FXML private TableColumn<PayslipRow, Double> payslip_baseCol;
    @FXML private TableColumn<PayslipRow, Double> payslip_overtimeCol;
    @FXML private TableColumn<PayslipRow, Double> payslip_bonusCol;
    @FXML private TableColumn<PayslipRow, Double> payslip_grossCol;
    @FXML private TableColumn<PayslipRow, Double> payslip_deductCol;
    @FXML private TableColumn<PayslipRow, Double> payslip_netCol;
    @FXML private TableColumn<PayslipRow, String> payslip_statusCol;
    @FXML private Label payslip_countLabel;

    // ==================== SUMMARY LABELS ====================
    @FXML private Label summary_totalEmployees;
    @FXML private Label summary_totalContracts;
    @FXML private Label summary_totalPayslips;
    @FXML private Label summary_totalBonuses;
    ...
    private void loadContracts() {
        try {
            List<ContractRow> contracts = financeDataService.getAllContracts();
    ...
    private void loadBankAccounts() {
        try {
            List<BankAccountRow> accounts = financeDataService.getAllBankAccounts();
    ...
    private void loadBonuses() {
        try {
            List<BonusRow> bonuses = financeDataService.getAllBonuses();
    ...
    private void loadPayslips() {
        try {
            List<PayslipRow> payslips = financeDataService.getAllPayslips();
