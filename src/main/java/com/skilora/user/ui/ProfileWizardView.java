...
import com.skilora.user.controller.ProfileWizardController;
...
public class ProfileWizardView extends VBox {
    ...
    private void loadFXML() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/skilora/view/user/ProfileWizardView.fxml"));
            ...
            getChildren().add(new javafx.scene.control.Label(com.skilora.utils.I18n.get("profile.load_error")));
        }
    }
