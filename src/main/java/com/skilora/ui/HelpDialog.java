...
public class HelpDialog {
    ...
    public static void show(javafx.stage.Window owner) {
        ...
        dialog.setDialogTitle("Aide & Support");
        dialog.setDescription("Ressources et informations d'assistance");

        VBox content = new VBox(20);
        content.setPadding(new Insets(16));

        // Quick Links Section
        VBox quickLinksSection = createSection("Liens Rapides",
            createHelpItem("📚 Documentation", "Consultez la documentation complète", null),
            createHelpItem("🎥 Tutoriels vidéo", "Regardez nos guides vidéo", null),
            createHelpItem("💡 FAQ", "Questions fréquemment posées", null)
        );

        // Contact Section
        VBox contactSection = createSection("Nous Contacter",
            createHelpItem("📧 Email", "support@skilora.tn", "mailto:support@skilora.tn"),
            createHelpItem("📞 Téléphone", "+216 XX XXX XXX", "tel:+216XXXXXXXX"),
            createHelpItem("🌐 Site Web", "www.skilora.tn", "https://skilora.tn")
        );
        ...
        ButtonType closeBtn = new ButtonType("Fermer", ButtonBar.ButtonData.OK_DONE);
