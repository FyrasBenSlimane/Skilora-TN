...
public class MainView extends TLAppLayout {
    ...
    public MainView(User user) {
        ...
        // Show dashboard for employer, feed for user
    ...
    private void showDashboard() {
        ...
        // For USER role, redirect to feed instead of dashboard
        ...
        if (cachedDashboardView == null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/skilora/view/usermanagement/DashboardView.fxml"));
                ...
                if (controller != null) {
                    // For EMPLOYER: pass post job and inbox callbacks
                    if (currentUser.getRole() == com.skilora.model.enums.Role.EMPLOYER) {
                        ...
                        // For ADMIN: pass users view callback
                        controller.initializeContext(
                            currentUser,
                            this::showProfileView,
                            this::showFeedView,
    ...
    private void handleLogout() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/skilora/view/usermanagement/LoginView.fxml"));
    ...
    private void showUsersView() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/skilora/view/usermanagement/UsersView.fxml"));
    ...
    private void showUserForm(User existingUser) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/skilora/view/usermanagement/UserFormDialog.fxml"));
    ...
    private void showFeedView() {
        ...
        if (cachedFeedView == null) {
            try {
                ...
                com.skilora.controller.recruitment.FeedController controller = loader.getController();
                if (controller != null) {
                    controller.setOnJobClick(this::showJobDetails);
                    controller.setOnApplyClick(this::openApplicationDialog);
                }
            } catch (Exception e) {
    ...
    private void showSettingsView() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/skilora/view/usermanagement/SettingsView.fxml"));
    ...
    private void openApplicationDialog(com.skilora.model.entity.recruitment.JobOpportunity job) {
        try {
            ...
            if (jobOfferId <= 0) {
                // Try to find by title and company (only in visible offers - OPEN and ACTIVE, excludes CLOSED)
                try {
            ...
            if (jobOfferId <= 0) {
                com.skilora.utils.DialogUtils.showError("Erreur", "Impossible de trouver cette offre d'emploi dans la base de données.");
                return;
            }
            ...
            // Load FXML
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/skilora/view/recruitment/ApplicationDialogView.fxml"));
    ...
    private void showNotificationsView() {
        ...
        if (cachedNotificationsView == null) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/skilora/view/usermanagement/NotificationsView.fxml"));
    ...
    public void showForgotPasswordView() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/skilora/view/usermanagement/ForgotPasswordView.fxml"));
    ...
    public void showError(com.skilora.controller.usermanagement.ErrorController.ErrorType type, String message, String details) {
        centerStack.getChildren().clear();
        
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/skilora/view/usermanagement/ErrorView.fxml"));
    ...
    private void showReportsView() {
        ...
        // Always recreate to refresh data
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/skilora/view/usermanagement/ReportsView.fxml"));
