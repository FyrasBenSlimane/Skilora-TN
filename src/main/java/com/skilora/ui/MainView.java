...
public class MainView extends TLAppLayout {
    ...
    private boolean supportUnread = false;
    ...
    public void showForgotPasswordView() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/skilora/view/user/ForgotPasswordView.fxml"));
            VBox forgotPasswordContent = loader.load();
            
            com.skilora.user.controller.ForgotPasswordController controller = loader.getController();
            if (controller != null) {
