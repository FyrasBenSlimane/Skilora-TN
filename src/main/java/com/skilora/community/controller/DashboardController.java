...
public class DashboardController {
    ...
    /**
     * Legacy 4-arg version for backward compatibility.
     */
    public void initializeContext(User user, Runnable toProfile, Runnable toFeed, Runnable toUsers) {
        initializeContext(user, toProfile, toFeed, toUsers, null);
    }

    public void setNavigationCallbacks(Runnable toPostJob, Runnable toInbox, Runnable toFormation, Runnable toCommunity, Runnable toFinance) {
        // Store these if needed for navigation from dashboard actions
        // Currently quick actions use the existing onNavigateToX callbacks
    }
