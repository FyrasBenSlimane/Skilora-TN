...
public class DashboardController {
    ...
    public void initializeContext(User user, Runnable toProfile, Runnable toFeed, Runnable toPostJob,
            Runnable toInbox) {
        this.currentUser = user;
        this.onNavigateToProfile = toProfile;
        this.onNavigateToFeed = toFeed;
        ...
        switch (currentUser.getRole()) {
            case ADMIN:
                statsGrid.getChildren().addAll(
                        createStatCard(I18n.get("dashboard.stat.users"), "15,230",
                                "+120" + I18n.get("common.per_month"), true),
            ...
            case EMPLOYER:
                statsGrid.getChildren().addAll(
                        ...
                        createStatCard(I18n.get("dashboard.stat.interviews"), "3", I18n.get("dashboard.stat.this_week"),
                                false));
                break;
            case USER:
            default:
                statsGrid.getChildren().addAll(
                        ...
                        createStatCard(I18n.get("dashboard.stat.applications"), "8",
                                I18n.get("dashboard.stat.in_progress"), false),
                        createStatCard(I18n.get("dashboard.stat.match_score"), "85%", I18n.get("dashboard.stat.high"),
                                true));
                break;
        }
    }
        ...
        switch (currentUser.getRole()) {
            case ADMIN:
                activityList.getChildren().addAll(
                        createActivityItem(I18n.get("dashboard.activity.system"),
                                I18n.get("dashboard.activity.admin.backup"),
                                I18n.get("dashboard.activity.time.minutes", 10)),
                        createActivityItem(I18n.get("dashboard.activity.security"),
                                I18n.get("dashboard.activity.admin.login_fail", "192.168.1.55"),
                                I18n.get("dashboard.activity.time.minutes", 25)),
                        createActivityItem(I18n.get("dashboard.activity.user"),
                                I18n.get("dashboard.activity.admin.employer_validated", "TechCorp"),
                                I18n.get("dashboard.activity.time.hours", 1)));
                break;
            case EMPLOYER:
                activityList.getChildren().addAll(
                        createActivityItem(I18n.get("dashboard.activity.application"),
                                I18n.get("dashboard.activity.employer.applied", "Ahmed B.", "Dev Java"),
                                I18n.get("dashboard.activity.time.minutes", 5)),
                        createActivityItem(I18n.get("dashboard.activity.system"),
                                I18n.get("dashboard.activity.employer.expiring", "Senior dev"),
                                I18n.get("dashboard.activity.time.hours", 2)));
                break;
            case USER:
            default:
                activityList.getChildren().addAll(
                        createActivityItem(I18n.get("dashboard.activity.offer"),
                                I18n.get("dashboard.activity.user.new_match"),
                                I18n.get("dashboard.activity.time.minutes", 2)),
                        createActivityItem(I18n.get("dashboard.activity.application"),
                                I18n.get("dashboard.activity.user.viewed", "TechCorp"),
                                I18n.get("dashboard.activity.time.hours", 1)));
                break;
        }
    }
    ...
    private void setupLabels() {
        ...
        statsTitle.setText(I18n.get("dashboard.title.stats"));
        activityTitle.setText(I18n.get("dashboard.title.activity"));
    }
