...
public class ApplicationsController implements Initializable {
            ...
            if (applicationsList != null) {
                ...
                if (apps != null) {
                    for (Application app : apps) {
                        ...
                        // Create line with name, status, and interview info if available
    ...
    private HBox createApplicationLine(String title, Application.Status status, Interview interview) {
        ...
        // Status badge
        TLBadge statusBadge = createStatusBadge(status);
