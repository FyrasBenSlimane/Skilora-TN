    ...
    private void loadDataAsync() {
        Task<List<JobOpportunity>> loadTask = new Task<>() {
            ...
            protected List<JobOpportunity> call() {
                try {
                    // Load only visible job offers (OPEN and ACTIVE, excludes CLOSED)
                    var offers = jobService.findVisibleJobOffers();
                    
                    // Convert JobOffer to JobOpportunity for display
                    ...
                    for (var offer : offers) {
                        ...
                        opp.setType(offer.getWorkType() != null ? offer.getWorkType() : "Temps plein");
