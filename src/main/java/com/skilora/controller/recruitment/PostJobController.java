        ...
        new Thread(() -> {
            try {
                ...
                if (salaryText.contains("-")) {
                    ...
                    try {
                        double singleSalary = Double.parseDouble(salaryText.trim());
                ...
                javafx.application.Platform.runLater(() -> {
                    if (success) {
                        publishBtn.setText("✓ " + (isEditMode ? I18n.get("postjob.updated", "Mis à jour") : I18n.get("postjob.published")));
                        ...
                        publishBtn.setText(isEditMode ? I18n.get("postjob.update_error", "Erreur de mise à jour") : I18n.get("postjob.publish_error"));
