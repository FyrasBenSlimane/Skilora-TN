...
public class TLAppLayout extends BorderPane {
    ...
    public static void applyStylesheets(javafx.scene.Scene scene) {
        java.net.URL theme = TLAppLayout.class.getResource(STYLESHEET_THEME);
        java.net.URL components = TLAppLayout.class.getResource(STYLESHEET_COMPONENTS);
        java.net.URL utilities = TLAppLayout.class.getResource(STYLESHEET_UTILITIES);
        ...
        if (utilities != null) scene.getStylesheets().add(utilities.toExternalForm());
    }
    ...
    public static void applyStylesheets(javafx.scene.control.DialogPane pane) {
        ...
        if (components != null) pane.getStylesheets().add(components.toExternalForm());
        if (utilities != null) pane.getStylesheets().add(utilities.toExternalForm());
    }
