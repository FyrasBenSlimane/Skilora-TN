...
public class TLBadge extends StackPane {
    ...
    public void setVariant(Variant variant) {
        ...
        if (currentVariant != null && currentVariant != Variant.DEFAULT) {
    ...
    // FXML property setter - accepts String and converts to enum
    public void setVariant(String variantStr) {
        try {
            Variant variant = Variant.valueOf(variantStr.toUpperCase());
            setVariant(variant);
